...
class PingPongServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getPingPong = channel.unary_unary(
                '/com.training.grpc.PingPongService/getPingPong',
...
def add_PingPongServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'com.training.grpc.PingPongService', rpc_method_handlers)
...
class PingPongService(object):
    ...
    def getPingPong(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.training.grpc.PingPongService/getPingPong',
